...
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Formulario /</span> Registrar Servicio</h4>
<style>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nombre" name="nombre"
                                placeholder="Ej: SOFTWARE" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="descripcion" name="descripcion" rows="3"
                                placeholder="Descripcion del servicios" required></textarea>
                        </div>
                    </div>
