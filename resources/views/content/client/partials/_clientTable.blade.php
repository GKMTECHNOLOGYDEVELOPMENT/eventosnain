         ...
         <td>
             @php
                 ...
                 if (
                     ...
                     $cliente->correo == 'SI' &&
                     $cliente->whatsapp == 'PENDIENTE' &&
                     $cliente->llamada == 'PENDIENTE' &&
                     $cliente->reunion == 'PENDIENTE'
                 ) {
                     $status = 'En Proceso';
                     $badgeClass = 'badge-warning-custom'; // Amarillo para En Proceso
         ...
         <td class="text-center">
             <div class="d-flex justify-content-center gap-2">
                 <a href="{{ route('client.edit', $cliente->id) }}"
                     ...
                     style="width: 40px; height: 40px;" title="Editar">
                 ...
                 <form action="{{ route('client.destroy', $cliente->id) }}" method="POST">
                     ...
                     <button type="submit"
                         ...
                         style="width: 40px; height: 40px;" title="Eliminar"
